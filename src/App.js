      ...
      <div className={"container py-md-5 container--narrow"}>
        ...
        <Canvas concurrent colorManagement camera={{ position: [0, 0, 120], fov: 70 }}>
          ...
          <Suspense fallback={null}>
            <HTMLContent domContent={domContent} bgColor="#f15946" modelPath="/armchairYellow.gltf" position={250}>
              <span>Meet the new </span>
              <span>shopping experience </span>
              <span>for online chairs</span>
            </HTMLContent>
            <HTMLContent domContent={domContent} bgColor="#571ec1" modelPath="/armchairGreen.gltf" position={0}>
              <span>Shit... we even</span>
              <span>got different colors</span>
            </HTMLContent>
            <HTMLContent domContent={domContent} bgColor="#636567" modelPath="/armchairGray.gltf" position={-250}>
              <span>And yes</span>
